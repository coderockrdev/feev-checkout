...
import { IndexComponent as CheckoutIndexComponent } from "./pages/checkout/index/index.component";
...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: ":transaction",
        children: [{ path: "", component: CheckoutIndexComponent }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [{ path: "", component: Demo2IndexComponent }],
  },
  {
    path: "demo3",
    component: Demo3Component,
    children: [{ path: "", component: Demo3IndexComponent }],
  },
  {
    path: "demo4",
    component: Demo4Component,
    children: [{ path: "", component: Demo4IndexComponent }],
  },
  {
    path: "demo5",
    component: Demo5Component,
    children: [{ path: "", component: Demo5IndexComponent }],
  },
  {
    path: "demo6",
    component: Demo6Component,
    children: [{ path: "", component: Demo6IndexComponent }],
  },
  {
    path: "demo7",
    component: Demo7Component,
    children: [{ path: "", component: Demo7IndexComponent }],
  },
  {
    path: "demo8",
    component: Demo8Component,
    children: [{ path: "", component: Demo8IndexComponent }],
  },
  {
    path: "demo9",
    component: Demo9Component,
    children: [{ path: "", component: Demo9IndexComponent }],
  },
  {
    path: "demo10",
    component: Demo10Component,
    children: [{ path: "", component: Demo10IndexComponent }],
  },
];
