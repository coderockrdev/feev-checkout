...
export class AppComponent {
  ...
  private demoClassMap: Record<string, string> = {
    ...
    demo3:
      "[--header-height:58px] [--sidebar-width:58px] [--navbar-height:56px] lg:overflow-hidden bg-muted",
    ...
    demo7:
      "[--header-height-default:95px] data-kt-[sticky-header=on]:[--header-height:60px] [--header-height:var(--header-height-default)] [--header-height-mobile:70px]",
    demo8: "[--header-height:60px] [--sidebar-width:90px] bg-muted",
    demo9: "[--header-height:78px]",
    demo10:
      "[--header-height:60px] [--sidebar-width:270px] lg:overflow-hidden bg-mono dark:bg-background",
  };
