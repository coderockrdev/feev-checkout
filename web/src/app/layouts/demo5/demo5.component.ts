import { Component, HostBinding, inject, AfterViewInit } from "@angular/core";
...
export class Demo5Component implements AfterViewInit {
  @HostBinding("class") bodyClass =
    "flex grow flex-col in-data-kt-[sticky-header=on]:pt-(--header-height)";
